 ...
 function setCurrentProjectData(o) {
     localStorage.setItem('current-projectdata-json', encrypt(JSON.stringify(o)));
 }

 function getCurrentProjectData() {
     var retrievedObject = localStorage.getItem('current-projectdata-json');
     return decrypt(JSON.parse(retrievedObject));
 }


 function setProjectData(o) {
     localStorage.setItem('projectdata-json', encrypt(JSON.stringify(o)));
 }

 function getProjectData() {
     var retrievedObject = localStorage.getItem('projectdata-json');
     return decrypt(JSON.parse(retrievedObject));
 }
