var configCode = {
    highlight: [{
            highlight: ['OnClick{', 'EndAnimation{', 'OnLongClick{', 'OnFocusIn{', 'OnKeyPress{', 'OnTouch{',
        ...
        {
            highlight: ['showSnack(', 'speed(', 'equals(', 'contains(', 'less(', 'bigger(', 'hide(', 'get(', 'set(', 'show(', 'invoke(', 'play(', 'reset(', 'loop(', 'pause(', 'showToast(', 'setIcon(', 'setText(', 'appendText(', 'fadeIn(',
                ...
                'date(', 'startapp(', 'exec(', 'navigate(', 'json(', 'calc(', 'startbottomsheet(', 'setTitle(', 'setBackgroundColor('
