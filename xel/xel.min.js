                ...
                // Animate the dialog
                {
                    if (this.hasAttribute("hidden") === false) {
                        ...
                        if (getComputedStyle(this).left === "0px" && getComputedStyle(this).right !== "0px") {
                            this._showAnimation = this.animate({ transform: [`translateX(-${dialogRect.right}px)`, "translateX(0px)"] }, { duration: transitionDuration, easing: transitionTimingFunction });
                        }
                        // Animate from right
                        else if (getComputedStyle(this).right === "0px" && getComputedStyle(this).left !== "0px") {
                            this._showAnimation = this.animate({ transform: [`translateX(${dialogRect.width}px)`, "translateX(0px)"] }, { duration: transitionDuration, easing: transitionTimingFunction });
                        }
                        // Animate from top
                        else {
                            this._showAnimation = this.animate({ transform: [`translateY(-${dialogRect.bottom}px)`, "translateY(0px)"] }, { duration: transitionDuration, easing: transitionTimingFunction });
                        }
                    }
                }
            ...
            return new Promise(async(resolve) => {
                // Animate the dialog
                {
                    ...
                    if (this.hasAttribute("hidden") === false) {
                        ...
                        // Animate to left
                        if (getComputedStyle(this).left === "0px" && getComputedStyle(this).right !== "0px") {
                            this._closeAnimation = this.animate({ transform: ["translateX(0px)", `translateX(-${dialogRect.right}px)`] }, { duration: transitionDuration, easing: transitionTimingFunction });
                        }
                        // Animate to right
                        else if (getComputedStyle(this).right === "0px" && getComputedStyle(this).left !== "0px") {
                            this._closeAnimation = this.animate({ transform: ["translateX(0px)", `translateX(${dialogRect.width}px)`] }, { duration: transitionDuration, easing: transitionTimingFunction });
                        }
                        // Animate to top
                        else {
                            this._closeAnimation = this.animate({ transform: ["translateY(0px)", `translateY(-${dialogRect.bottom + 50}px)`] }, { duration: transitionDuration, easing: transitionTimingFunction });
                        }
        ...
        async _onPointerDown(pointerDownEvent) {
            ...
            if (header.contains(pointerDownEvent.target) && this.contains(closestFocusableElement) === false) {
                ...
                if (triggerEffect === "ripple") {
                    ...
                    let inAnimation = ripple.animate({ transform: ["scale3d(0, 0, 0)", "none"] }, { duration: 300, easing });

                    await whenLostPointerCapture;
                    await inAnimation.finished;

                    let outAnimation = ripple.animate({ opacity: [getComputedStyle(ripple).opacity, "0"] }, { duration: 300, easing });
...
`;
    ...
    let parseColor = (colorString, outputModel = "rgba") => {
        ...
        // HEX, e.g. "#fff"
        else if (tokens != null && tokens != undefined && tokens.length > 0 && tokens[0].type === "HEX" && tokens[1] === undefined) {
        ...
        async _onButtonPointerDown(pointerDownEvent) {
            ...
            // Ripple
            {
                ...
                if (triggerEffect === "ripple") {
                    ...
                    let inAnimation = ripple.animate({ transform: ["scale3d(0, 0, 0)", "none"] }, { duration: 300, easing: easing$1 });
                    ...
                    if (delay) {
                        ...
                        let outAnimation = ripple.animate({ opacity: [getComputedStyle(ripple).opacity || "0", "0"] }, { duration: 300, easing: easing$1 });
                    ...
                    let inAnimation = ripple.animate({ transform: ["scale(0)", "scale(1)"] }, { duration: 200, easing: easing$1 });

                    await whenLostPointerCapture;
                    await inAnimation.finished;

                    let outAnimation = ripple.animate({ opacity: [getComputedStyle(ripple).opacity || "0", "0"] }, { duration: 200, easing: easing$1 });
        ...
        async _onButtonClick(event) {
            ...
            if (this["#ripples"].querySelector(".pointer-down-ripple") === null) {
                ...
                if (triggerEffect === "ripple") {
                    ...
                    await ripple.animate({ transform: ["scale3d(0, 0, 0)", "none"] }, { duration: 300, easing: easing$1 }).finished;

                    await ripple.animate({ opacity: [getComputedStyle(ripple).opacity || "0", "0"] }, { duration: 300, easing: easing$1 }).finished;
        ...
        _onPointerDown(event) {
            ...
            // Ripple
            {
                ...
                if (rippleType === "unbounded") {
                    ...
                    let transformAnimation = ripple.animate({ transform: ["scale(0)", "scale(2.6)"] }, { duration: 200, easing: easing$2 });
                    ...
                    this.addEventListener("lostpointercapture", async() => {
                        ...
                        let opacityAnimation = ripple.animate({ opacity: [getComputedStyle(ripple).opacity, "0"] }, { duration: 200, easing: easing$2 });
...
`;
  ...
  <template>
    ...
    <!-- <svg id="close-button" onclick="exitProject(this)" viewBox="0 0 100 100" preserveAspectRatio="none">
        ...
        async _onPointerDown(pointerDownEvent) {
            ...
            // Trigger effect
            {
                ...
                if (triggerEffect === "ripple") {
                    ...
                    let inAnimation = ripple.animate({ transform: ["scale3d(0, 0, 0)", "none"] }, { duration: 300, easing: easing$4 });

                    await whenLostPointerCapture;
                    await inAnimation.finished;

                    let outAnimation = ripple.animate({ opacity: [getComputedStyle(ripple).opacity, "0"] }, { duration: 300, easing: easing$4 });
    ...
    class XNotificationElement extends HTMLElement {
        ...
        _onOpen() {
            ...
            if (this.isConnected) {
                ...
                let inAnimation = this.animate({ bottom: [fromBottom, toBottom] }, { duration: 300, easing: "cubic-bezier(0.4, 0, 0.2, 1)" });
            }
        ...
        _onPointerDown(event) {
            ...
            // Ripple
            {
                ...
                if (rippleType === "unbounded") {
                    ...
                    let transformAnimation = ripple.animate({ transform: ["translate(-50%, -50%) scale(0)", "translate(-50%, -50%) scale(1)"] }, { duration: 200, easing: easing$5 });
                    ...
                    this.addEventListener("lostpointercapture", async() => {
                        ...
                        let opacityAnimation = ripple.animate({ opacity: [getComputedStyle(ripple).opacity, "0"] }, { duration: 200, easing: easing$5 });
  ...
  <template>
    <style>
      :host {
        ...
        --selection-indicator-height: 2px;
        --selection-indicator-background: #2196f375;
      }
      :host(:focus) {
        outline: none;
      }
...
`;
    ...
    class XTagInputElement extends HTMLElement {
        ...
        <div class="item" data-tag="${tag}">
          ...
          <svg class="close-button" editable  viewBox="0 0 100 100"><path class="close-button-path"></path></svg>
        </div>
      `);
            }
